...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    secondary: 'bg-dark-800 hover:bg-dark-700 text-gray-300 border border-dark-600 focus:ring-dark-500',
    danger: 'bg-red-600 hover:bg-red-700 text-white focus:ring-red-500',
    success: 'bg-emerald-600 hover:bg-emerald-700 text-white focus:ring-emerald-500',
    ghost: 'text-gray-400 hover:text-gray-200 hover:bg-dark-800 focus:ring-dark-500',
  };
